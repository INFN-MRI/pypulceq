...
def write_sequence(seqname, seqdict):
    ...
    # write entry file
    print("Entry file...\n")
    writeentryfile("toppeN.entry", filePath=f"/usr/g/research/pulseq/seqfiles/{seqname}/")
    ...
    archive_and_cleanup(f"{seqname}.tar", ["toppeN.entry", "seqstamp.txt", "modules.txt", "scanloop.txt", "cores.txt"] + modfiles)
